...
- circle_t是圆类，继承父类shape_t，将父类定义成子类结构的第一个元素来继承父类，将子类类型定义在c文件中实现对外隐藏子类；
...
- rectangle_t是矩形类，继承父类shape_t，将父类定义成子类结构的第一个元素来继承父类，将子类类型定义在c文件中实现对外隐藏子类；
...
- triangle_t是三角类，继承父类shape_t，将父类定义成子类结构的第一个元素来继承父类，将子类类型定义在c文件中实现对外隐藏子类；
